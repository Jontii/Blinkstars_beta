...
mock.onGet('/api/customers').reply(() => {
  const customers: Customer[] = [
    ...
    },
    {
      ...
      country: 'USA',
      currency: 'SEK',
      email: 'anje.keizer@blinkstars.io',
    ...
    },
    {
      ...
      avatar: `${process.env.PUBLIC_URL}/images/avatars/avatar_9.svg`,
      currency: 'SEK',
      email: 'emilee.simchenko@blinkstars.io',
      hasAcceptedMarketing: true,
      isProspect: false,
      isReturning: false,
      city: 'Carson City',
    ...
    },
    {
      ...
      country: 'USA',
      currency: 'SEK',
      email: 'elliott.stone@blinkstars.io',
      hasAcceptedMarketing: true,
      isProspect: false,
      isReturning: true,
      name: 'Elliott Stone',

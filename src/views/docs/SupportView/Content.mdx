...
Our support mainly covers pre-sale questions, basic theme questions and bug reports through our support email: <a href="mailto:support@blinkstarsio.zendesk.com">support@blinkstarsio.zendesk.com</a>. 
